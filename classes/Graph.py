...
# classes GraphHTML & GraphDescendantHtml & GraphList & Bridge

class GraphHtml(QMainWindow):   # Ancestors = Vorfahren
    ...
    def on_clicked(self, element_id: str, x: int, y: int):  # acting on click event (on a div with person box)
        try:
            ...
            print ("ERROR: GraphHtml => on_clicked()")
